...
const BacaBukuPage = () => {
  ...
  useEffect(() => {
    ...
    // Merge user books with dummy books (user books first)
        ...
        <div className="px-4 py-5 space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-3 overflow-x-auto pb-2 -mx-1 px-1 scrollbar-hide">
              {(searchQuery ? filteredBooks : getMostLikedBooks(4)).map((book: Book) => (
          ...
          <div>
            ...
            {/* Horizontal Scroll Books */}
            <div className="flex gap-3 overflow-x-auto pb-2 -mx-1 px-1 scrollbar-hide">
              {(searchQuery ? filteredBooks : getMostViewedBooks(4)).map((book: Book) => (
                <div key={book.id} className="flex-shrink-0 w-[100px]">
                  <BookCard book={book} />
                </div>
              ))}
