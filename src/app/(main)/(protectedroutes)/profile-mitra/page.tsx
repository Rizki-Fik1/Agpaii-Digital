...
export default function MitraProfilePage() {
  ...
  const FormFields = () => (
    <div className="space-y-5">
      <div className="group">
        ...
        <div
          className={`flex items-center gap-3 border-b pb-2.5 ${isEditing ? "border-green-300" : "border-gray-100"}`}
        >
          <FiBriefcase className="text-green-500 w-5 h-5 flex-shrink-0" />
          <input
            name="instansi"
      ...
      <div className="group">
        ...
        <div
          className={`flex items-center gap-3 border-b pb-2.5 ${isEditing ? "border-green-300" : "border-gray-100"}`}
        >
          <FiUser className="text-green-500 w-5 h-5 flex-shrink-0" />
          <input
            name="pic"
            value={formData.pic}
            onChange={handleChange}
      ...
      <div className="group">
        ...
        <div className="flex items-center gap-3 border-b border-gray-100 pb-2.5">
          <FiMail className="text-green-500 w-5 h-5 flex-shrink-0" />
          <input
            name="email"
      ...
      <div className="group">
        ...
        <div
          className={`flex items-center gap-3 border-b pb-2.5 ${isEditing ? "border-green-300" : "border-gray-100"}`}
        >
          <FiPhone className="text-green-500 w-5 h-5 flex-shrink-0" />
          <input
            name="phone"
  ...
  return (
    <>
      {/* ========== MOBILE LAYOUT ========== */}
      <div className="md:hidden pt-[4.5rem] bg-gray-50 min-h-screen pb-24">
        ...
        <div className="px-5">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-6">
            <h3 className="font-bold text-gray-800 border-b pb-2 mb-6">
              Informasi Mitra
            </h3>
            <FormFields />
          </div>
      ...
      <div className="hidden md:block min-h-screen bg-transparent pt-[4.5rem]">
        <div className="px-6 lg:px-8 py-6">
          {/* Desktop Header */}
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-slate-800">Profil Mitra</h1>
            <p className="text-slate-500 text-sm mt-1">Kelola informasi dan identitas mitra Anda.</p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <div className="col-span-1">
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                {/* Cover */}
                <div className="h-28 bg-gradient-to-br from-green-500 to-teal-600 relative">
                  <div className="absolute inset-0 bg-[url('/img/pattern.svg')] opacity-10"></div>
                </div>

                {/* Avatar & Name */}
                <div className="px-6 pb-6 -mt-12 text-center relative">
                  <div className="w-24 h-24 mx-auto rounded-full border-4 border-white shadow-lg bg-gray-200 overflow-hidden relative group">
                    {formData.logo ? (
                      <img
                        src={formData.logo}
                        alt="Logo"
                  ...
                  <div className="mt-5 space-y-2">
                    {!isEditing ? (
                      <button
                        ...
                        className="w-full py-2.5 bg-green-50 text-green-600 font-semibold rounded-xl hover:bg-green-100 transition flex items-center justify-center gap-2 text-sm border border-green-200"
                      >
                      ...
                      <>
                        <button
                          onClick={handleSave}
                          disabled={loading}
                          className="w-full py-2.5 bg-green-500 text-white font-semibold rounded-xl hover:bg-green-600 transition flex items-center justify-center gap-2 text-sm disabled:opacity-70"
                        >
                          {loading ? (
                        ...
                        <button
                          onClick={handleCancelEdit}
                          className="w-full py-2.5 bg-gray-100 text-gray-600 font-semibold rounded-xl hover:bg-gray-200 transition text-sm"
                        >
                          Batal
                        </button>
                      </>
              ...
              <button
                onClick={handleLogout}
                className="w-full mt-4 py-2.5 bg-white text-red-500 font-medium rounded-xl hover:bg-red-50 transition flex items-center justify-center gap-2 text-sm border border-slate-200"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4"
            ...
            <div className="col-span-2">
              <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8">
                <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-100">
                  <div>
                    <h3 className="text-lg font-bold text-gray-800">Informasi Mitra</h3>
                    <p className="text-xs text-gray-400 mt-0.5">Detail informasi akun mitra Anda</p>
                  </div>
                  {isEditing && (
