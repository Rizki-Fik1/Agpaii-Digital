    ...
    <>
      ...
      <div className="hidden md:block min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-8 py-8 space-y-8">
          ...
          {/* Menu Grid Desktop (full width) */}
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            <h2 className="text-base font-bold text-slate-700 mb-5">Layanan AGPAY</h2>
            <div className="grid grid-cols-5 lg:grid-cols-6 xl:grid-cols-8 gap-5">
              {menus.map((menu, i) => (
                <Link
                  key={i}
                  href={menu.link}
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            {/* Info Card */}
            <div className="bg-gradient-to-br from-[#004D40] to-[#009788] rounded-2xl p-5 text-white self-start">
              <div>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-white/20 hover:bg-white/30 border border-white/30 text-white text-xs font-semibold px-4 py-2.5 rounded-xl transition-all w-fit"
              >
      ...
      {transactions.slice(0, 3).map((transaction: TransactionType) => {
        ...
        return (
          <Link href={`/history-transaction/${transaction.trxid}`} key={transaction.trxid}>
            <div className="group py-3 px-1 hover:bg-slate-50 rounded-lg transition-all duration-200">
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="text-right flex-shrink-0">
                  ...
                  <span className={clsx("text-[10px] font-medium px-2 py-0.5 rounded-full inline-block mt-0.5", color)}>
                    {label}
                  </span>
                </div>
              </div>
